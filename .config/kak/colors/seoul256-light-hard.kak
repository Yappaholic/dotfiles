...
set-face global Default ",%opt{gray11}@Default"
set-face global Default "%opt{black1}@Default"
...
set-face global ts_constant_builtin_boolean "%opt{mauve}"
set-face global ts_constant_character ts_constant
set-face global ts_constant_character_escape "%opt{salmon3}"
set-face global ts_constant_macro ts_constant
set-face global ts_constant_numeric "%opt{magenta2}"
...
set-face global ts_constructor "%opt{brown1}"
...
set-face global ts_function "%opt{green4}"
set-face global ts_function_builtin "%opt{blue1}"
set-face global ts_function_macro "%opt{green4}"
...
set-face global ts_namespace "%opt{blue4}"
set-face global ts_operator "%opt{brown1}"
set-face global ts_punctuation "%opt{brown1}"
...
set-face global ts_special "%opt{green4}"
set-face global ts_string "%opt{blue6}"
...
set-face global ts_type "%opt{brown1}"
set-face global ts_type_builtin "%opt{salmon3}"
set-face global ts_type_enum ts_type
set-face global ts_type_enum_variant ts_type_enum
set-face global ts_variable "%opt{black1}"
set-face global ts_variable_builtin "%opt{salmon3}"
set-face global ts_variable_other ts_variable
set-face global ts_variable_other_member "%opt{black1}"
set-face global ts_variable_parameter "%opt{black1}"

# kakoune-lsp
set-face global DiagnosticError "red"
set-face global DiagnosticHint "%opt{green1}"
set-face global DiagnosticInfo "%opt{green1}"
set-face global DiagnosticWarning "%opt{yellow1}"
set-face global InlayHint "%opt{gray6}+b"
set-face global LineFlagError "red+b"
set-face global LineFlagHint "blue+b"
set-face global LineFlagInfo "%opt{green1}+b"
set-face global LineFlagWarning "%opt{yellow5}+b"
set-face global Reference ",%opt{gray10}+u"