...
set-face global DiagnosticHint "%opt{shade04}"
set-face global DiagnosticInfo "%opt{light_blue}"
set-face global DiagnosticWarning "%opt{orange}"
set-face global InlayHint "%opt{shade03_darker}"
set-face global LineFlagError "red"
set-face global LineFlagHint "%opt{shade04}"
set-face global LineFlagInfo "%opt{light_blue}"
set-face global LineFlagWarning "%opt{orange}"
set-face global Reference "%opt{shade00},%opt{shade04}"